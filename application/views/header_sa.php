...
<div id="mySidenav" class="sidenav">
    ...
    <a><?php echo anchor("c_super_admin", 'Home', ['class'=>'btn btn-outline-info']);?></a>
    <a><?php echo anchor("c_crud", 'Data Barang', ['class'=>'btn btn-outline-primary']);?></a>
    <a><?php echo anchor("c_crud/tambah", 'Tambah Barang', ['class'=>'btn btn-outline-success']);?></a>
    <a><?php echo anchor("c_log/log_daftar", 'History Daftar', ['class'=>'btn btn-outline-warning']);?></a>
    <a><?php echo anchor("c_log", 'History Barang', ['class'=>'btn btn-outline-warning']);?></a>
